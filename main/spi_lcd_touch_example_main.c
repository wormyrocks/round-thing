...
// https://github.com/Spotpear/ESP32-C3-1.28inch-Round-LCD/blob/main/1-Demo/Demo_Arduino/1_1_Factory_samples/Factory_samples/CST816D.h
...
#define EXAMPLE_PIN_NUM_TOUCH_I2C_SDA 4
#define EXAMPLE_PIN_NUM_TOUCH_I2C_SCL 5
...
static void touch_intr_cb(esp_lcd_touch_handle_t tp)
{
...
{
    if (xSemaphoreTake(touch_mux, 0) == pdFALSE) return;
    esp_lcd_touch_handle_t tp = (esp_lcd_touch_handle_t) drv->user_data;
    ...
    ESP_LOGI("Touch", "%d %d %d", touch_x[0], touch_y[0], touch_strength[0]);
...
void app_main(void)
{
    ...
    const i2c_config_t i2c_conf = {
        ...
        .sda_io_num = EXAMPLE_PIN_NUM_TOUCH_I2C_SDA,
        .sda_pullup_en = GPIO_PULLUP_DISABLE,
        .scl_io_num = EXAMPLE_PIN_NUM_TOUCH_I2C_SCL,
    ...
    ESP_ERROR_CHECK(esp_lcd_new_panel_io_i2c((esp_lcd_i2c_bus_handle_t)EXAMPLE_TOUCH_I2C_NUM, &tp_io_config, &io_handle));
